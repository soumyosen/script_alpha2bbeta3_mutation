...
axs[0].text(0.3, 3.5, ': present', color='blue', fontsize=12)
axs[0].text(1.6, 3.5, ': absent', color='red', fontsize=12)
...
plt.tight_layout()
#plt.show()
plt.savefig("interaction1.png", dpi=400)
