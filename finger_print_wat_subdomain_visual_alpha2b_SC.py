...
axs[0].scatter(0.2, 8.6, s=25, c='b', clip_on=False)
axs[0].scatter(1.5, 8.6, s=25, c='r', clip_on=False)
axs[0].text(0.3, 8.4, ': present', color='blue', fontsize=14)
axs[0].text(1.6, 8.4, ': absent', color='red', fontsize=14)
...
plt.tight_layout()
#plt.show()
plt.savefig("interaction_alpha2B_SC.png", dpi=400)
